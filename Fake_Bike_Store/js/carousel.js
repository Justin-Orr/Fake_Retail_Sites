...
function slide_transition1() {
  carousel_image.style.backgroundImage = "url(images/bikebanner.jpg)";
  select_label_1()
  counter = 1;
}

function slide_transition2() {
  carousel_image.style.backgroundImage = "url(images/dirt-bike.jpg)";
  select_label_2()
  counter = 2;
}

function slide_transition3() {
  carousel_image.style.backgroundImage = "url(images/wiseman-bike-frames-1202.jpg)";
  select_label_3()
  counter = 3;
}

function slide_transition4() {
  carousel_image.style.backgroundImage = "url(images/bike.jfif)";
  select_label_4()
  counter = 4;
}
